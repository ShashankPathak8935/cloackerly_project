    ...
    "
                ...
                <div className="flex justify-between mt-6">
                  <button
                    type="button"
                    onClick={prevStep}
                    className="bg-slate-700 hover:bg-slate-600 text-white px-4 py-2 rounded-md cursor-pointer text-sm font-medium transition duration-150"
                  >
                    ‹ Previous
                  </button>
                  {location?.state?.mode === "edit" && (
                    <button
                      type="button"
                      onClick={handleSubmit(onSubmit)}
                      className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-3 py-2 rounded-md cursor-pointer text-sm font-medium transition duration-150"
                    >
                      <svg
                        className="w-4 h-4"
                        aria-hidden="true"
